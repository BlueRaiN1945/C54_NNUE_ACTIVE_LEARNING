...
The exact manifest is kept outside the public Git tree until redistribution
status/source-data policy is finalized.
...
The historical `V0_ONE_FEN_001` integration fixture originated from VAL and
must never become active-learning training data.
